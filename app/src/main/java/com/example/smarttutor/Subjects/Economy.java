...
public class Economy extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("articles").child("economy");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> itemsAdapter = new ArrayAdapter<>(Economy.this, android.R.layout.simple_list_item_1, titleList);
