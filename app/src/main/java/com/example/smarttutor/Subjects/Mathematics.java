...
public class Mathematics extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("articles").child("mathematics");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> itemsAdapter = new ArrayAdapter<>(Mathematics.this, android.R.layout.simple_list_item_1, titleList);
