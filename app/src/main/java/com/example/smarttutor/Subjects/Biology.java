...
public class Biology extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("articles").child("biology");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> itemsAdapter = new ArrayAdapter<>(Biology.this, android.R.layout.simple_list_item_1, titleList);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //GlobalValuesArticles.parseValues(articleList.get(i), "Biology");
                Intent intent = new Intent(Biology.this, DisplaySingleArticle.class);
