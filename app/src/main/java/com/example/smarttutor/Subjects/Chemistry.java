...
public class Chemistry extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("articles").child("chemistry");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> itemsAdapter = new ArrayAdapter<>(Chemistry.this, android.R.layout.simple_list_item_1, titleList);
        ...
        imageView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event){
                Intent intent = new Intent(Chemistry.this, Home.class);
                Chemistry.this.startActivity(intent);
                return false;
            }
        });
